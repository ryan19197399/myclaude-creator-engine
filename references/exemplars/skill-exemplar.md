...
description: >-
  ...
  Use when: evaluating complex decisions, pressure-testing conclusions, or building
  adversarial-proof arguments. Updates at myclaude.sh/p/systematic-reasoning
# ─── Frontier Frontmatter (examples of optional fields) ───
# allowed-tools: Read, Grep, Glob     # this skill only reads, never writes
# model: claude-opus-4-6              # deep reasoning benefits from strongest model
# effort: high                        # always use maximum reasoning effort
